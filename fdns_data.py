...
def load_data(data_dir):
    ...
    input_normalized_val_torch = torch.from_numpy(input_normalized_val).float()#.cuda()
    output_normalized_val_torch = torch.from_numpy(output_normalized_val).float()#.cuda()

    from torch.utils.data import TensorDataset, DataLoader
    train_dataset = TensorDataset(input_normalized_torch,output_normalized_torch) # create your training datset
    val_dataset = TensorDataset(input_normalized_val_torch,output_normalized_val_torch) # create your val datset
    ...
    return train_dataset, val_dataset, input_normalized_val_torch, output_normalized_val_torch
